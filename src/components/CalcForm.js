...
const CalcForm = () => {
  return <div className='w-full bg-white max-w-[942px] mx-auto rounded-2xl text-darkblue p-12 shadow-primary'
    ...
    <div className='mt-24'>
      ...
      <div className='text-gray-500 tracking-[1%]'>Revenue will change on mining difficulty and Ethereum price.</div>
    </div>
  </div>;
};
