...
const Trade = () => {
  ...
  return <section className='section lg:pt-[320px] bg-gradient-to-b from-[#f8f9fb] to-[#fafbff] text-darkblue
    lg:-mt-[320px]'>
    <div className='container mx-auto'>
      <h2 className='section-title text-center mb-16' data-aos='fade-up' data-a0s-offset='400'
      >Trade securely and market the high growth cryptocurrencies</h2>

      {/*Items */}
      <div className='flex flex-col gap-[45px] lg:flex-row' data-aos='fade-up' data-a0s-offset='450'>
